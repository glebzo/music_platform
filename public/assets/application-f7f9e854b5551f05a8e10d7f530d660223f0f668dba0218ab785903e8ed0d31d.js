...
(function() {
  ...
  MusicPlatform.on('before:start', function() {
    var RegionContainer;
    ...
    return MusicPlatform.regions = new RegionContainer();
  });

  MusicPlatform.on('start', function() {
    var channelsCollection, channelsCollectionView;
    channelsCollection = new MusicPlatform.ChannelsCollection([
      {
        id: 1,
        name: 'Ambient'
      }, {
        ...
        name: 'Atmosphere Beats'
      }
    ]);
    channelsCollectionView = new MusicPlatform.ChannelsCollectionView({
      collection: channelsCollection
    });
    return MusicPlatform.regions.channels.show(channelsCollectionView);
  });

  jQuery(function() {
    console.log('Dependincies are loaded. Starting Application ...');
    MusicPlatform.start();
    return console.log('Marionette Application started!');
  });
...
(function() {
  ...
  MusicPlatform.ChannelModel = (function(superClass) {
    extend(ChannelModel, superClass);

    function ChannelModel() {
      return ChannelModel.__super__.constructor.apply(this, arguments);
    }

    ChannelModel.prototype.defaults = {
      name: 'Channel',
      currentTrack: 'Soundtrack',
      currentPage: '',
      totalPages: '',
      img150: "/images/img150",
      img256: ''
    };
...
(function() {
  ...
  MusicPlatform.ChannelsCollection = (function(superClass) {
    extend(ChannelsCollection, superClass);

    function ChannelsCollection() {
      return ChannelsCollection.__super__.constructor.apply(this, arguments);
    }

    ChannelsCollection.prototype.url = '/channels';

    ChannelsCollection.prototype.model = MusicPlatform.ChannelModel;

    ChannelsCollection.prototype.comparator = 'name';
...
(function() {
  MusicPlatform.ChannelView = Marionette.ItemView.extend({
    template: '#channels-item-view'
  });
...
(function() {
  ...
  MusicPlatform.ChannelsCollectionView = (function(superClass) {
    extend(ChannelsCollectionView, superClass);

    function ChannelsCollectionView() {
      return ChannelsCollectionView.__super__.constructor.apply(this, arguments);
    }

    ChannelsCollectionView.prototype.childView = MusicPlatform.ChannelView;
